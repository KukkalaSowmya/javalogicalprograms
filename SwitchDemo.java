...
public class SwitchDemo
  {
    ...
    {
      //Declaring and initializing marks variables. You can change marks and test your program again.
      int marks=82;
      //Dividing marks by 10 to limit the number of cases
      marks=marks/10;
      //Enclosing marks in switch expressions to check against matching case.
